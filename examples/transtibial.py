...
# Transtibial ################
osim_file = "./models/osim/Transtibial/OS4_gait14dof15musc_2Act_RTFP_Homebrew_V3.osim"
geometry_folder = "./models/osim/Transtibial//Geometry"
output_folder = "./models/mjc/Transtibial"
