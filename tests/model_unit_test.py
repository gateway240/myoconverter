...
osim_file = './tests/resource/model_unit_test/osim/Arm26/arm26.osim'
geometry_folder = './tests/resource/model_unit_test/osim/Arm26/Geometry'
output_folder = './tests/resource/model_unit_test/mjc/Arm26'
